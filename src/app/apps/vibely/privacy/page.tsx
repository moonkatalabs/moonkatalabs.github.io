...
export default function VibelyPrivacyPage() {
  return (
    <main className="w-full max-w-[500px] mx-auto px-5 pt-[100px] pb-[100px] space-y-[50px] text-left">
      ...
      <p>
        Your privacy is important to us. It is Aibek Mazhitov&apos;s policy to respect your privacy and comply with any
        applicable law and regulation regarding any personal information we may collect about you, including via our app,
        Vibely - Music Visualizer, and its associated services.
      </p>
      ...
      <p>
        In the event our app contains links to third-party sites and services, please be aware that those sites and services
        ...
        to any of your activities after you leave our app.
      </p>
      ...
      <h4 className="text-lg font-semibold mt-4">Collection and Use of Information</h4>
      ...
      <p>
        ...
        provide you with an enhanced experience of our app and services.
      </p>

      <h4 className="text-lg font-semibold mt-4">Security of Your Personal Information</h4>
      <p>
      ...
      <h4 className="text-lg font-semibold mt-4">How Long We Keep Your Personal Information</h4>
      <p>
      ...
      <h3 className="text-xl font-semibold mt-6">Disclosure of Personal Information to Third Parties</h3>
      ...
      <h3 className="text-xl font-semibold mt-6">Your Rights and Controlling Your Personal Information</h3>
      <p>
        <strong>Your choice:</strong> By providing personal information to us, you understand we will collect, hold, use, and
      ...
      <p>
        <strong>Information from third parties:</strong> If we receive personal information about you from a third party, we
      ...
      <p>
        <strong>Marketing permission:</strong> If you have previously agreed to us using your personal information for direct
        marketing purposes, you may change your mind at any time by contacting us using the details below.
      </p>
      ...
      <p>
        <strong>Correction:</strong> If you believe that any information we hold about you is inaccurate, out of date,
      ...
      <p>
        <strong>Non-discrimination:</strong> We will not discriminate against you for exercising any of your rights over your
      ...
      <p>
        <strong>Notification of data breaches:</strong> We will comply with laws applicable to us in respect of any data
        breach.
      </p>

      <p>
        <strong>Complaints:</strong> If you believe that we have breached a relevant data protection law and wish to make a
      ...
      <p>
        Our privacy policy covers the use of cookies between your device and our servers. A cookie is a small piece of data
        ...
        that serves the purpose of the cookie, and any self-maintenance information about the cookie itself.
      </p>

      <p>
        We use cookies to give your device access to core features of our app, to track app usage and performance on your
        device, to tailor your experience of our app based on your preferences, and to serve advertising to your device. Any
        communication of cookie data between your device and our servers occurs within a secure environment.
      </p>
      ...
      <p>
        Our app may link to external sites that are not operated by us. Please be aware that we have no control over the
      ...
      <h3 className="text-xl font-semibold mt-6">Additional Disclosures for Australian Privacy Act Compliance (AU)</h3>
      <h4 className="text-lg font-semibold mt-4">International Transfers of Personal Information</h4>
      <p>
        Where the disclosure of your personal information is solely subject to Australian privacy laws, you acknowledge that
      ...
      <h3 className="text-xl font-semibold mt-6">Additional Disclosures for California Compliance (US)</h3>
      <p>
      ...
      <h4 className="text-lg font-semibold mt-4">CCPA-permitted financial incentives</h4>
      <p>
        In accordance with your right to non-discrimination, we may offer you certain financial incentives permitted by the
        CCPA that can result in different prices, rates, or quality levels for the goods or services we provide.
      </p>

      <p>
        Any CCPA-permitted financial incentive we offer will reasonably relate to the value of your personal information, and
      ...
      <h4 className="text-lg font-semibold mt-4">California Notice of Collection</h4>
      <p>
        For more information on information we collect, including the sources we receive information from, review the &quot;Information
      ...
      <p>
        Aibek Mazhitov<br />
        <a href="mailto:contact@moonkata.com" className="text-[#7A78FF]">contact@moonkata.com</a>
      </p>

      <section>
        <Link href="/apps/vibely" className="text-[#7A78FF]">
          Home
        </Link>
      </section>
    </main>
